...
export const chartPatient = {
  ...
  ward: "2D病棟",
  department: "脳神経内科",
  conferenceAt: "2026年7月4日 14:30",
  conferenceAtShort: "2026/07/04 14:30",
  conferencePoint: "2026/07/04 14:30",
...
export const conferenceNotice =
  "本カルテは2026年7月4日 14:30の退院前カンファレンス時点の情報です。";
...
export const nursingNotes = [
  {
    ...
    soap: {
      ...
      O: "救急搬送後，誤嚥性肺炎の診断で2D病棟入院。BT 38.2℃，SpO2 99％，鼻カヌラ3L。湿性咳嗽，喀痰あり。上肢筋力低下あり，ナースコール操作や飲水動作に時間を要する。発声は可能だが，疲労時に発話がやや不明瞭。夫，長女が来院し，入院時説明を受ける。",
  ...
  },
  {
    ...
    conference: {
      ...
      plan:
        "退院前カンファレンスを2026/07/04 14:30に実施予定。訪問看護と在宅医の導入を検討する。PT・OTによる退院後の生活場面評価も必要。福祉用具や自宅環境調整については，家族の意向と支援可能量を確認したうえで検討する。本人，夫，長女の意向と認識に差がないか，退院前カンファレンスで確認する。"
    }
  },
  {
...
export const doctorNotes = [
  {
    title: "医師記録1　2026/06/25 12:00",
    soap: {
      S: "夕食時に強いむせ込みがあり，その後から咳嗽，喀痰，呼吸苦が出現したとのこと。長女が救急要請。本人は「食事中にむせることが増えていた」と話す。",
      O: "BT 38.2℃，BP 138/78 mmHg，HR 104/min，RR 24/min，SpO2 99％。鼻カヌラ3Lで管理。湿性咳嗽あり。WBC 12,800/μL，Neut 84％，CRP 8.6 mg/dL。胸部所見より誤嚥性肺炎として矛盾しない。",
    ...
    orders: [
      ...
      "酸素 鼻カヌラ3Lより開始，SpO2 94％以上を目安に調整",
      "発熱時，解熱鎮痛薬使用可",
  ...
  },
  {
    ...
    soap: {
      ...
      P: "本日14:30に退院前カンファレンスを実施予定。医学的には退院検討可能であることを共有する。退院後も食形態はきざみ食，水分とろみを継続し，発熱，咳嗽増悪，喀痰増加，呼吸苦出現時には早めに医療機関へ相談する方針とする。"
    },
    orders: [
      "抗菌薬は2026/07/01終了済み",
      "食事はきざみ食，水分とろみ継続",
      "発熱，咳嗽増悪，喀痰増加，呼吸苦出現時は医療機関へ相談",
      "本日14:30に退院前カンファレンス予定"
    ]
  }
] as const;
